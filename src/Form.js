...
class Form extends Component {
  ...
  componentDidMount() {
    const purpose = [
      ...
      { value: 'Autogestión', label: 'Autogestión: gobernanza urbana, trabajo colaborativo en red...' },
      ...
      { value: 'Participación ciudadana', label: 'Participación ciudadana: trabajo colaborativo, herramientas para la organización ciudadana, empoderamiento vecinal...' },
      ...
      { value: 'Personas mayores', label: 'Personas mayores: atención a la tercera edad, envejecimiento activo...' },
      ...
      { value: 'Gentrificación', label: 'Gentrificación: Turistificación, apartamentos turísticos...' }
    ]
